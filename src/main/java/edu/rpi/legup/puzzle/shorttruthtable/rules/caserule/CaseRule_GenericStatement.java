...
public abstract class CaseRule_GenericStatement extends CaseRule_Generic {
    ...
    public CaseRule_GenericStatement(
            String ruleID,
            char operation,
            String title,
        ...
        super(
                ruleID,
                ShortTruthTableOperation.getRuleName(operation),
                title + " case",
     ...
     */
    private ArrayList<Board> getCasesFromCell(
            ShortTruthTableBoard board,
            PuzzleElement puzzleElement,
            ShortTruthTableCellType[][] possibilities) {
